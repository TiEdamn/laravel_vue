...
var getUsers = function getUsers(page, callback) {
  _api_users__WEBPACK_IMPORTED_MODULE_0__["default"].all(page).then(function (response) {
      ...
      ? _c(
          ...
          [
            _c(
              ...
              {
                attrs: {
                  to: { name: _vm.prevRoute.name, query: _vm.prevRoute.query }
                }
              },
              [_vm._v("Back")]
            )
...
__webpack_require__(/*! /Users/tie/Files/Prog/php/vue-router/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/tie/Files/Prog/php/vue-router/resources/sass/app.scss */"./resources/sass/app.scss");
